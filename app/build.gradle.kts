...
abstract class ExportReleaseToDesktopTask : DefaultTask() {
  ...
  fun export() {
    ...
    val baseName = "BreathSpace-v${versionName.get()}-vc${versionCode.get()}"
    val aabTarget = File(desktop, "$baseName.aab")
    val txtTarget = File(desktop, "$baseName-release-notes.txt")
...
android {
  namespace = "com.jeiel85.breathspace"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.jeiel85.breathspace"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0.0"
...
tasks.register<ExportReleaseToDesktopTask>("exportReleaseToDesktop") {
  group = "breathspace"
  description = "Copies the release AAB and Play Console release notes to the user's Desktop"
